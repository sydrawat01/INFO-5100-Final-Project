    ...
    for(Enterprise.EnterpriseType type: Enterprise.EnterpriseType.values()) {
      if(type.toString() != null) switch(type.toString()) {
        ...
        case "Government":
          ...
          Employee emp12 = e12.getEmployeeDirectory().createEmployee("NYInsurance");
          emp12.setEmpEmail(email);
          Account acc12 = e12.getUserAccountDirectory().createUserAccount("NYInsurance", "password1234", emp12, new EnterpriseAdmin());
          break;
        default:
          break;
      }
