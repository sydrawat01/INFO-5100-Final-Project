...
public class ManageEnterpriseAdmins extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 140, 540, 220));

        lblNetwork.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        lblNetwork.setForeground(new java.awt.Color(64, 123, 255));
        lblNetwork.setText("Network");
        add(lblNetwork, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 410, -1, -1));
        ...
        add(cbNetwork, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 400, 136, -1));

        lblUsername.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        lblUsername.setForeground(new java.awt.Color(64, 123, 255));
        lblUsername.setText("Username");
        add(lblUsername, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 500, -1, -1));
        add(txtUsername, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 500, 136, 25));
        ...
        add(lblEnterprise, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 450, -1, -1));

        cbEnterprise.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Item 1", "Item 2", "Item 3", "Item 4" }));
        add(cbEnterprise, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 450, 136, -1));
        ...
        add(btnSubmit, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 700, 90, 40));

        lblPassword.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        lblPassword.setForeground(new java.awt.Color(64, 123, 255));
        lblPassword.setText("Password");
        add(lblPassword, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 550, -1, -1));
        add(txtName, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 650, 136, 28));

        lblName.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        lblName.setForeground(new java.awt.Color(64, 123, 255));
        lblName.setText("Name");
        add(lblName, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 660, -1, -1));
        add(txtPassword, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 550, 136, 25));
        ...
        add(txtConfirmPassword, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 600, 136, 29));

        lblConfirmPassword.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        lblConfirmPassword.setForeground(new java.awt.Color(64, 123, 255));
        lblConfirmPassword.setText("Confirm Password");
        add(lblConfirmPassword, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 600, -1, -1));

        lblTitle.setFont(new java.awt.Font("Tahoma", 1, 24)); // NOI18N
        lblTitle.setForeground(new java.awt.Color(64, 123, 255));
        lblTitle.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        lblTitle.setText("Manage Enterprise Admin");
        add(lblTitle, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 60, 352, -1));
