...
public class ManageEnterprises extends javax.swing.JPanel {
  ...
  private void initComponents() {
    ...
    add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(61, 76, 561, 95));

    lblNetwork.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
    lblNetwork.setForeground(new java.awt.Color(255, 255, 255));
    lblNetwork.setText("Network");
    add(lblNetwork, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 218, -1, -1));

    cbNetwork.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Item 1", "Item 2", "Item 3", "Item 4" }));
    add(cbNetwork, new org.netbeans.lib.awtextra.AbsoluteConstraints(234, 216, 136, -1));

    lblName.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
    lblName.setForeground(new java.awt.Color(255, 255, 255));
    lblName.setText("Name");
    add(lblName, new org.netbeans.lib.awtextra.AbsoluteConstraints(147, 318, -1, -1));
    add(txtName, new org.netbeans.lib.awtextra.AbsoluteConstraints(234, 316, 136, -1));
    ...
    add(lblEnterprise, new org.netbeans.lib.awtextra.AbsoluteConstraints(88, 269, -1, -1));

    cbEnterprise.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Item 1", "Item 2", "Item 3", "Item 4" }));
    add(cbEnterprise, new org.netbeans.lib.awtextra.AbsoluteConstraints(234, 267, 136, -1));
    ...
    add(btnSubmit, new org.netbeans.lib.awtextra.AbsoluteConstraints(234, 399, -1, 34));
    ...
    add(btnBack, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 35, -1, -1));

    lblTitle.setBackground(new java.awt.Color(255, 255, 255));
    lblTitle.setFont(new java.awt.Font("Tahoma", 1, 24)); // NOI18N
    lblTitle.setForeground(new java.awt.Color(255, 255, 255));
    lblTitle.setText("Manage Enterprise ");
    add(lblTitle, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 26, -1, -1));
    ...
    add(btnDelete, new org.netbeans.lib.awtextra.AbsoluteConstraints(520, 182, -1, 34));
    add(txtAddress, new org.netbeans.lib.awtextra.AbsoluteConstraints(232, 348, 138, -1));

    lblAddress.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
    lblAddress.setForeground(new java.awt.Color(255, 255, 255));
    lblAddress.setText("Address");
    add(lblAddress, new org.netbeans.lib.awtextra.AbsoluteConstraints(135, 351, -1, -1));

    btnMap.setBackground(new java.awt.Color(255, 204, 51));
    btnMap.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
    btnMap.setText("View on Map");
    add(btnMap, new org.netbeans.lib.awtextra.AbsoluteConstraints(399, 344, -1, -1));
